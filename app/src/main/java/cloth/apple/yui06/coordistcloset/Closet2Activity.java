...
public class Closet2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cloth.apple.yui06.coordistcloset.R.layout.activity_closet2);

        bitmap2 = BitmapFactory.decodeResource(getResources(), cloth.apple.yui06.coordistcloset.R.drawable.white);
        listView2 = (ListView)findViewById(cloth.apple.yui06.coordistcloset.R.id.listView2);

        bCards = new ArrayList<CardBottom>();

        memo2Adapter = new Memo2Adapter(this, cloth.apple.yui06.coordistcloset.R.layout.activity_card_bottom, bCards);
        listView2.setAdapter(memo2Adapter);
        realm = Realm.getDefaultInstance();


        add2 = (FloatingActionButton) findViewById(cloth.apple.yui06.coordistcloset.R.id.add2);
    ...
    public void setMemoList() {
        ...
        Bitmap bmp1=BitmapFactory.decodeResource(res, cloth.apple.yui06.coordistcloset.R.drawable.white);
