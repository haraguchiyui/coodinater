...
public class randomActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(cloth.apple.yui06.coordistcloset.R.layout.activity_random);

            imageTops = (ImageView) findViewById(cloth.apple.yui06.coordistcloset.R.id.imageTops);
            imageBottoms = (ImageView) findViewById(cloth.apple.yui06.coordistcloset.R.id.imageBottoms);
