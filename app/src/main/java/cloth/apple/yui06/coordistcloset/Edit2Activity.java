...
public class Edit2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cloth.apple.yui06.coordistcloset.R.layout.activity_edit2);

        imageView2 = (ImageView) findViewById(cloth.apple.yui06.coordistcloset.R.id.imageView2);

        colorEditText2 = (EditText) findViewById(cloth.apple.yui06.coordistcloset.R.id.colorEditText2);
        contentEditText2 = (EditText) findViewById(cloth.apple.yui06.coordistcloset.R.id.contentEditText2);
        addData2=(Button)findViewById(cloth.apple.yui06.coordistcloset.R.id.addData);
