...
import static com.example.yui06.coodinater.Edit2Activity.REQUEST_CODE_CAMERA;
import static com.example.yui06.coodinater.Edit2Activity.REQUEST_CODE_GALLERY;
...
public class ReEdit2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_re_edit2);

        realm=Realm.getDefaultInstance();

        colorText1=(EditText)findViewById(R.id.colorText1);
